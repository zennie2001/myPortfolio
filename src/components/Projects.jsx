...
function Projects() {
  ...
  const tags = ["All", "Full Stack", "React", "Node.js", "MongoDB", "API"];
  ...
  return (
   <div id="skills" className=' w-full sm:pb-10 md:h-[170vh] pt-20'>
      {/* Title */}
      <div className='pb-16'>
        ...
        {filteredProjects.map((img, index) => (
          <div key={index} className=" rounded-lg shadow-md overflow-hidden pb-4">
            <div className="relative group overflow-hidden">
              ...
              />
              <div className="absolute bottom-2 left-2   text-md font-semibold px-2 py-1 rounded">
                {img.title}
              </div>
            </div> 
            ...
            <hr/>
            {/* Image description */}
            <div className="p-4  text-gray-700 dark:text-white font-medium">
              {img.description}
              ...
              <div className='p-4 flex justify-between'>
                ...
                <div className='flex gap-4'>
                  <a href={img.github} target="_blank" rel="noopener noreferrer">
                    <LuGithub className='text-xl cursor-pointer text-gray-700 hover:text-black' />
                  </a>
                  <a href={img.live} target="_blank" rel="noopener noreferrer">
                    <LuExternalLink className='text-xl cursor-pointer text-gray-700 hover:text-black' />
                  </a>
                </div>
