...
function Footer() {
  return (
     <div id="contact" className='bg-blue-200 dark:bg-gray-800'>
        <div className='flex  flex-col items-center sm:grid grid-cols-[1fr_1.2fr_1fr] gap-14 mb-10 pt-20 text-sm px-20'>
          {/* 1st part */}
